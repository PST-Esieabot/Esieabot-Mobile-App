# Sources :
# https://stackoverflow.com/questions/66401660/how-can-i-automate-pairing-rpi-and-android-with-bluetooth-batch-script
...
def autopair():
    print("Lancement de l'appareillage automatique")
